...
## 2. Proposed Model
<img width="650" alt="image" src="https://github.com/user-attachments/assets/59438b4f-a18a-4e72-ac2c-735b9c6a3056" />
...
- **get_polarity_score()**:  
  Calculates the overall sentiment score for each review.

- **get_sentiment_label()**:  
  Assigns a sentiment label to the reviews based on the overall sentiment score:  
...
- **Accuracy:** Successfully recommends relevant products like 'Pants,' 'Swim,' and 'Lounge,' with repeated suggestions for 'Lounge,' reflecting its precision in matching user preferences.
- **Consistency:** Provides diverse and contextually appropriate recommendations across categories such as swimwear, sleepwear, and casual wear, demonstrating its understanding of review semantics.
